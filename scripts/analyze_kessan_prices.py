...
<style>
  ...
  .page-header {{ background: #fff; border-bottom: 0.5px solid #e0ddd8; padding: 0.75rem 1.5rem; display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap; }}
...
<div class="page-header">
  <h1>決算日±1 株価変動分析</h1>
  <nav class="top-nav">
    <a href="https://fortissimo147.github.io/Okaka/">2083モニタリング</a>
